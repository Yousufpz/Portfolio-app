	...
	<div class="columns introduction">
		<div class="column has-text-left has-text-centered-mobile">
			...
			<p class="description mt-3">
				<span class="is-size-5 is-italic text-highlight" style="display: block; margin-bottom: 0.75rem;">
					"Jack of all trades, master of none, but often better than a master of one."
				</span>
				<span>
					Passionate backend & AI engineer specializing in transforming complex infrastructure, agentic pipelines, and automation requirements into highly scalable, robust products.
				</span>
			</p>
			<div
